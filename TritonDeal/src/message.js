export default {
  ...
  VALIDATE_EAMIL: 'Greate! An email is sent to your email address to verify. Please click the link inside the email to activeate your account.',
  RESET_PASSWORD: 'An email is sent to your email address to reset password.',
